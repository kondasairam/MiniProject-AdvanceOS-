...
//Declared mutex and barrier for pthread objects
...
void SimpleThread(int which) {
   ...
   for(num=0; num < 20; num++) {
     ...
     //protecting access by locking the resource(shared variable)
     pthread_mutex_lock(&mutex);
     SharedVariable = val+1;
     //releasing the access by unlocking the resource
...
int main(int argc, char *argv[]){
   ...
   //Initialized both mutex and barrier setting the barries to given cmd arg
   ...
   //destroying both mutex and barrier
